...
namespace Problem01
{
    class Program
    {
        ...
        {
            uint y;
            for (y = 0; y < 1000000000/4; y++)
            summ1(y);
        }
        static void TestThread2()
        {
            uint y;
            for (y = 1000000000/4; y < 1000000000/2; y++)
            summ2(y);
        }
        static void TestThread3()
        {
            uint y;
            for (y = 1000000000/2; y < 750000000; y++)
            summ3(y);
        }
        static void TestThread4()
        {
            uint y;
            for (y = 750000000; y < 1000000000; y++)
            summ4(y);
        }
        ...
        static void Main(string[] args)
        {
            ...
            Sum_Global = Sum_Global1+Sum_Global2+Sum_Global3+Sum_Global4;
            sw.Stop();
